...
public class Ejercicio07 {
    ...
    public static void main(String[] args) {
        ...
        // Bucle do-while principal para mantener la calculadora activa
        do {
            ...
            default: 
                ...
                System.out.println("\nOpción incorrecta. Por favor, seleccione A, B, C, D o E.");
                // Salimos del switch
                break;
            }
            
            // Añadimos línea en blanco para separar operaciones
            System.out.println();

        } while (!opcion.equals("E")); // Continuamos mientras no se seleccione "E" para salir
